...
from millionanimals.common.metrics.all_metrics import DetectionAccuracy
from PIL import Image
from albumentations.pytorch import ToTensorV2


class AnimalBoxesDataset(MillionAnimalsDataset):
    ...
    """
    _dataset_name = 'AnimalBoxes'
    _versions_dict = {
        '0.0': {
            'download_url':
                'https://github.com/weecology/MillionAnimals/releases/download/0.0.0-dev1/AnimalBoxes_v0.0.zip',
            'compressed_size':
                5940337
        },
        "0.1": {
            'download_url':
                "https://data.rc.ufl.edu/pub/ewhite/AnimalBoxes_v0.1.zip",
            'compressed_size':
                3476300
        },
        "0.2": {
    ...
    def __init__(self,
        ...
        self._collate = AnimalBoxesDataset._collate_fn

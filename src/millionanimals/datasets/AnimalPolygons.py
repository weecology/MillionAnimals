...
from millionanimals.common.metrics.all_metrics import MaskAccuracy
...
class AnimalPolygonsDataset(MillionAnimalsDataset):
    """The AnimalPolygons dataset is a collection of tree annotations annotated as multi-point polygon
    locations.
    ...
    """
    _dataset_name = 'AnimalPolygons'
    _versions_dict = {
        '0.0': {
            'download_url':
                'https://github.com/weecology/MillionAnimals/releases/download/0.0.0-dev1/AnimalPolygons_v0.0.zip',
            'compressed_size':
                17112645
        },
        "0.1": {
            'download_url':
                "https://data.rc.ufl.edu/pub/ewhite/AnimalPolygons_v0.1.zip",
            'compressed_size':
                40277152
        },
        "0.2": {
            'download_url':
                "https://data.rc.ufl.edu/pub/ewhite/AnimalPolygons_v0.2.zip",
            'compressed_size':
                75419767345
        }
    }

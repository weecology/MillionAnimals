...
from millionanimals.datasets.millionanimals_dataset import MillionAnimalsDataset
from millionanimals.common.grouper import CombinatorialGrouper
from millionanimals.common.metrics.all_metrics import KeypointAccuracy
from PIL import Image
import albumentations as A
from albumentations.pytorch import ToTensorV2


class AnimalPointsDataset(MillionAnimalsDataset):
    """The AnimalPoints dataset is a collection of tree annotations annotated as x,y locations.
    ...
    """
    _dataset_name = 'AnimalPoints'
    _versions_dict = {
        '0.0': {
            'download_url':
                'https://github.com/weecology/MillionAnimals/releases/download/0.0.0-dev1/AnimalPoints_v0.0.zip',
            'compressed_size':
                523312564
        },
        "0.1": {
            'download_url':
                "https://data.rc.ufl.edu/pub/ewhite/AnimalPoints_v0.1.zip",
            'compressed_size':
                170340
        },
        "0.2": {
            'download_url':
                "https://data.rc.ufl.edu/pub/ewhite/AnimalPoints_v0.2.zip",
            'compressed_size':
                1459676926
        }
    }
    ...
    def __init__(self,
        ...
        self._collate = AnimalPointsDataset._collate_fn

...
class MillionAnimalsDataset:
    """Shared dataset class for all MillionAnimals datasets.
    ...
    def get_subset(self, split, frac=1.0, transform=None):
        ...
        Output:
            - subset (MillionAnimalsSubset): A (potentially subsampled) subset of the WILDSDataset.
        """
        ...
        return MillionAnimalsSubset(self, split_idx, transform,
                                  self.geometry_name)
    ...
    def check_init(self):
        ...
        for attr_name in required_attrs:
            assert hasattr(
                self, attr_name), f'MillionAnimalsDataset is missing {attr_name}.'
    ...
    def split_dict(self):
        ...
        """
        return getattr(self, '_split_dict', MillionAnimalsDataset.DEFAULT_SPLITS)
    ...
    def dataset_exists_locally(self, data_dir, version_file):
        ...
        # 1. Automatically through the MillionAnimals package
    ...
    def download_dataset(self, data_dir, download_flag):
        ...
        from millionanimals.datasets.download_utils import download_and_extract_archive
...
class MillionAnimalsSubset(MillionAnimalsDataset):

    def __init__(self, dataset, indices, transform=None, geometry_name="y"):
        """This acts like `torch.utils.data.Subset`, but on `millionanimalsDatasets`.
    ...
    def __getitem__(self, idx):
        ...
        if self._dataset_name == 'AnimalPolygons':
            targets = {

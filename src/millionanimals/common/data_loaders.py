...
from millionanimals.common.utils import get_counts, split_into_groups
...
def get_train_loader(loader,
    ...
    Args:
        - loader (str): Loader type. 'standard' for standard loaders and 'group' for group loaders,
                        ...
                        to each group.
        - dataset (millionanimalsDataset or millionanimalsSubset): Data
    ...
    """
    if isinstance(dataset, MillionAnimalsDataset):
        print(

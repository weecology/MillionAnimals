...
def test_AnimalPolygons_generic(dataset):
    ds = AnimalPolygonsDataset(download=False, root_dir=dataset, version="0.0") 
...
def test_AnimalPolygons_eval(dataset):
    ds = AnimalPolygonsDataset(download=False, root_dir=dataset, version="0.0") 
    test_dataset = ds.get_subset("test")
...
def test_AnimalPolygons_download(tmpdir):
    ds = AnimalPolygonsDataset(download=True, root_dir=tmpdir, version="0.0")
    train_dataset = ds.get_subset("train")
